...
export const Projects = () => {
  ...
  const addProject = async (e) => {
    e.preventDefault();
    if (editProject) {
      const res = await axios.patch(`/api/projects/${editProject._id}`,
        formData
      );
      setProjects((prev) =>
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="space-y-4">
        {projects.length === 0 ? (
          ...
          projects.map(p => (
            <div key={p._id} className="bg-white p-4 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                      ...
                      <button
                        ...
                        title="Delete"
                      > <FontAwesomeIcon icon={faTrash} className="h-4 pr-0 w-4" />
                      </button>
                    </div>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-xl">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-semibold text-gray-800">{editProject ? "Edit Project" : "Add Project"}</h2>
              <button 
